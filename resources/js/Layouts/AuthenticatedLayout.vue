                                        ...
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                ...
                                                <div
                                                    ...
                                                    class="w-8 h-8 rounded-full overflow-hidden me-2"
                                                >
                                                    <img
                                                ...
                                                <div
                                                    v-else
                                                    class="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center me-2"
                                                >
                ...
                >
                    ...
                    >
                        <div class="px-4 flex items-center">
                            ...
                            <div
                                v-if="$page.props.auth.user.avatar"
                                class="w-12 h-12 rounded-full overflow-hidden me-3 flex-shrink-0"
                            >
                                <img
                                    :src="`/storage/${$page.props.auth.user.avatar}`"
                                    class="w-full h-full object-cover"
                            ...
                            <div
                                v-else
                                class="w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center me-3 flex-shrink-0"
                            >
